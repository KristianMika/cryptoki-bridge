...
use super::{
    ...
    decryption, encryption, key_management, message_digesting, object_management,
    session_management, signing, slot_token, unsupported,
};
...
pub unsafe fn C_GetFunctionList(ppFunctionList: CK_FUNCTION_LIST_PTR_PTR) -> CK_RV {
    ...
    let function_list = CK_FUNCTION_LIST {
        ...
        C_GetSlotList: Some(slot_token::C_GetSlotList),
        C_GetSlotInfo: Some(slot_token::C_GetSlotInfo),
        C_GetTokenInfo: Some(slot_token::C_GetTokenInfo),
        ...
        C_OpenSession: Some(session_management::C_OpenSession),
        C_CloseSession: Some(session_management::C_CloseSession),
        ...
        C_Login: Some(session_management::C_Login),
        C_Logout: Some(session_management::C_Logout),
        C_CreateObject: Some(object_management::C_CreateObject),
        C_CopyObject: Some(unsupported::C_CopyObject),
        C_DestroyObject: Some(object_management::C_DestroyObject),
        C_GetObjectSize: Some(unsupported::C_GetObjectSize),
        C_GetAttributeValue: Some(object_management::C_GetAttributeValue),
        C_SetAttributeValue: Some(unsupported::C_SetAttributeValue),
        C_FindObjectsInit: Some(object_management::C_FindObjectsInit),
        C_FindObjects: Some(object_management::C_FindObjects),
        C_FindObjectsFinal: Some(object_management::C_FindObjectsFinal),
        C_EncryptInit: Some(encryption::C_EncryptInit),
        C_Encrypt: Some(encryption::C_Encrypt),
        C_EncryptUpdate: Some(unsupported::C_EncryptUpdate),
        C_EncryptFinal: Some(unsupported::C_EncryptFinal),
        C_DecryptInit: Some(decryption::C_DecryptInit),
        C_Decrypt: Some(decryption::C_Decrypt),
        C_DecryptUpdate: Some(unsupported::C_DecryptUpdate),
        C_DecryptFinal: Some(unsupported::C_DecryptFinal),
        C_DigestInit: Some(message_digesting::C_DigestInit),
        C_Digest: Some(message_digesting::C_Digest),
        ...
        C_SignInit: Some(signing::C_SignInit),
        C_Sign: Some(signing::C_Sign),
        ...
        C_GenerateKey: Some(key_management::C_GenerateKey),
        C_GenerateKeyPair: Some(key_management::C_GenerateKeyPair),
        C_WrapKey: Some(key_management::C_WrapKey),
        C_UnwrapKey: Some(key_management::C_UnwrapKey),
